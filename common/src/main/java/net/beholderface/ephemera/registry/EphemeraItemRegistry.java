...
public class EphemeraItemRegistry {
    ...
    public static final RegistrySupplier<BlockItem> FAKE_SLATE = ITEMS.register("fakeslate", ()->new BlockItem(EphemeraBlockRegistry.SNEAKY_SLATE.get(), EPHEMERA_STACKABLE64));
}
