...
public class EphemeraBlockRegistry {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(Ephemera.MOD_ID, RegistryKeys.BLOCK);
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(Ephemera.MOD_ID, RegistryKeys.BLOCK_ENTITY_TYPE);
