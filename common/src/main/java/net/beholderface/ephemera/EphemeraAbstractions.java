...
public class EphemeraAbstractions {
     ...
     * Example:
     * <p>
     * Expect: net.beholderface.ephemera.EphemeraAbstractions#getConfigDirectory()
     * <p>
     * Actual Fabric: net.beholderface.ephemera.fabric.EphemeraAbstractionsImpl#getConfigDirectory()
     * <p>
     * Actual Forge: net.beholderface.ephemera.forge.EphemeraAbstractionsImpl#getConfigDirectory()
     * <p>
