...
import hexdoc_ephemera

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class EphemeraPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return EphemeraModPlugin(branch=branch)


class EphemeraModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "ephemera"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_ephemera, "_templates"
